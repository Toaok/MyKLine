...
import com.example.klinelib.util.DataUtils;
import com.example.klinelib.util.DisplayUtils;
...
/**
 * kline
 * Created by example on 2017/10/26.
 */
public class KLineView extends BaseView implements CoupleChartGestureListener.OnAxisChangeListener {
    ...
    public static final int MA5 = 5;//5日平均
    public static final int MA10 = 10;//10日平均
    public static final int MA20 = 20;//20日平均
    public static final int MA30 = 30;//30日平均
...
//        设置标签Y渲染器
    ...
    public void initData(List<HisData> hisDatas) {
        ...
        mChartPrice.zoom(MIN_COUNT_K * 1f / INIT_COUNT_K, 0, 0, 0);
        mChartVolume.zoom(MIN_COUNT_K * 1f / INIT_COUNT_K, 0, 0, 0);
        mChartMacd.zoom(MIN_COUNT_K * 1f / INIT_COUNT_K, 0, 0, 0);
        mChartKdj.zoom(MIN_COUNT_K * 1f / INIT_COUNT_K, 0, 0, 0);
    ...
    public CandleDataSet setKLine(int type, ArrayList<CandleEntry> lineEntries) {
        ...
        set.setNeutralColor(ContextCompat.getColor(getContext(), R.color.main_color_red));
    ...
    private void setOffset() {
        ...
        mChartPrice.setViewPortOffsets(0, 0, 45, chartHeight);
        int bottom = DisplayUtils.dip2px(mContext, 45);
        mChartVolume.setViewPortOffsets(0, 0, 45, bottom);
        mChartMacd.setViewPortOffsets(0, 0, 45, bottom);
        mChartKdj.setViewPortOffsets(0, 0, 45, bottom);
